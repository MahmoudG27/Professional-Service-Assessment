...
const DATABASE_NAME = process.env.COSMOS_DATABASE_NAME ?? "cloudreadydb";
const ASSESSMENTS_CONTAINER = process.env.COSMOS_ASSESSMENTS_CONTAINER ?? process.env.COSMOS_CONTAINER ?? "assessments";
