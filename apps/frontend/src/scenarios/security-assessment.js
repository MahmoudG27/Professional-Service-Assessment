...
export const securityAssessmentScenario = {
    ...
    findingRules: [
        ...
        },
        {
            ...
            finding: {
                ...
                description: "On-premises components must be included in the security assessment alongside Azure workloads.",
            },
        },
        {
            ...
            finding: {
                ...
                description: "Core security controls including MFA, encryption, vulnerability management, and incident response are already established.",
                businessImpact: "Assessment can focus on advanced hardening, governance, and optimisation rather than foundational controls.",
            },
        },
        {
            id: "no-siem",
            ...
            finding: {
                ...
                description: "No SIEM platform is in place to collect and analyse security events.",
                businessImpact: "Security incidents may remain undetected for extended periods."
            }
        },
    ],
    recommendationRules: [
