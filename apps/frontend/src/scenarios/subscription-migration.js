...
export const subscriptionMigrationScenario = {
    ...
    findingRules: [
        ...
        },
        {
            ...
            finding: {
                ...
                description: "Same-tenant migration with independent resources and no redeployment blockers — Azure Resource Mover can handle most of this migration directly.",
                businessImpact: "Reduces migration complexity, minimizes downtime risk, and avoids costly resource redeployment activities.",
            },
        },
        {
